...
echo '<input type="time" name="eventEnd" value="',$event['eventEnd'] ,'"></input>';
echo '<input type="text" name="eventDesc" value="',$event['eventDesc'] ,'"></input>';
echo '<input type="text" name="eventRes" value="',$event['eventRes'] ,'"></input>';
